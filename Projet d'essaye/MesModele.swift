...
var messages :[mesType] = [
    ...
    ,mesType(id: 2, msg: "Je vous attends pour réceptionner la commande?", time: "17:59", msgs: "6", name: "Aliswift", pic: "profile12")
    ,mesType(id: 3, msg: "Êtes-vous disponible?", time: "15:35", msgs: "4", name: "Jean-Serge", pic: "profile10")
